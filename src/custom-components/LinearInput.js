        ...
        return (
            <Form>
                ...
                <Form.Row>
                    ...
                    <Col>
                        <Form.Control type='text' placeholder={this.COST_PLACEHOLDER} onChange={event =>
                            this.setState({sup1rec2cost: event.target.value})}/>
                    </Col>
                    <Col>
                ...
                <Form.Row>
                    ...
                    <Col>
                        <Form.Control type='text' placeholder={this.COST_PLACEHOLDER} onChange={event =>
                            this.setState({sup3rec1cost: event.target.value})}/>
                    </Col>
                    <Col>
                        <Form.Control type='text' placeholder={this.COST_PLACEHOLDER} onChange={event =>
                            this.setState({sup3rec2cost: event.target.value})}/>
                    </Col>
                    <Col>
                ...
                <Form.Row>
                    ...
                    <Col>
                        <Form.Control type='text' placeholder={this.COST_PLACEHOLDER} onChange={event =>
                            this.setState({sup4rec1cost: event.target.value})}/>
                    </Col>
                    <Col>
                        <Form.Control type='text' placeholder={this.COST_PLACEHOLDER}  onChange={event =>
                            this.setState({sup4rec2cost: event.target.value})}/>
                    </Col>
                    <Col>
